      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="bg-card border border-border rounded-2xl p-8 md:p-12 relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center text-center gap-6">
            ...
            {/* Resume image preview - click to download */}
            <motion.div
            ...
            >
              <div className="relative overflow-hidden rounded-xl border-2 border-border group-hover:border-primary shadow-xl group-hover:shadow-primary/20 transition-all duration-300 max-w-sm mx-auto">
                <img
                  src={resumePreview}
                  alt="Resume Preview"
                ...
                <div className="absolute inset-0 bg-black/0 group-hover:bg-black/30 transition-colors duration-300 flex items-center justify-center">
                  <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col items-center gap-2 text-white">
                    ...
                    <span className="text-sm font-semibold">Click to Download</span>
                  </div>
                </div>
              </div>
            </motion.div>
